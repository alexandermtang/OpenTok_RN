  ...
  static navigationOptions = {
    header: (
      <View style={Styles.header}>
        ...
        >
          <Icon name="md-menu" size={28} color="white" style={{ fontWeight: 'bold' }} />
        </View>
        ...
        <View style={Styles.eventContainer}>
          <TouchableOpacity style={Styles.eventBox} onPress={() => this.publishAndView('Publish')}>
            <View style={{ flex: 0.2, alignItems: 'center', justifyContent: 'center' }}>
              <Icon name="ios-videocam" size={40} color="white" style={{ fontWeight: 'bold' }} />
            </View>
          ...
          <TouchableOpacity style={Styles.eventBox} onPress={() => this.publishAndView('Viewer')}>
            <View style={{ flex: 0.2, alignItems: 'center', justifyContent: 'center' }}>
              <Icon name="ios-eye" size={40} color="white" style={{ fontWeight: 'bold' }} />
            </View>
            <View style={{ flex: 0.8, justifyContent: 'center' }}>
